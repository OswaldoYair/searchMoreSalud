    ...
    <form action="{{route('usuarios.update', $user->id)}}" method="POST"  autocomplete="off">
        ...
        <div class="row">
            <div class="form-group col-md-6">
                <label for="rol">ROL</label>
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <select name="nameEs" id="Nombre_de_especialidad" class="form-control">
                            <option class="dropdown-item" value="{{ $user->especialidad}}" selected>Especialidad anteriormente seleccionada: {{ $user->especialidad}}</option>
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <select name="nameMu" id="municipio" class="form-control">
                        <option class="dropdown-item" value="{{ $user->municipio}}" selected>Municipio anteriormente seleccionado: {{ $user->municipio}}</option>
            ...
            <div class="form-group col-md-6">
                ...
                <input type="tel" maxlength="10" oninput="if(this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" pattern="([1-9]{3})([0-9]{7})" title="Ingresa solo numeros telefonicos" class="form-control" name="celular" required value="{{$user->celular}}" autocomplete="off" placeholder="Ingrese su celular">
            </div>
        </div>
        <div class="row">
            <div class="form-group col-md-6">
